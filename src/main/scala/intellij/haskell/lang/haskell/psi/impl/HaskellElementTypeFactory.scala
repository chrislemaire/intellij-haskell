...
import intellij.haskell.lang.haskell.psi.stubs.types.{HaskellConidStubElementType, HaskellConsymStubElementType, HaskellModidStubElementType, HaskellVaridStubElementType, HaskellVarsymStubElementType}
