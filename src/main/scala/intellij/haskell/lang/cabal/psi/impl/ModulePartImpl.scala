...
import intellij.haskell.lang.cabal.{CabalFile, CabalLanguage, psi}
import intellij.haskell.lang.cabal.psi.{CabalReference, ModulePart}
...
trait ModulePartImpl extends CabalNamedElementImpl {
  ...
  override def getContext: psi.Module = getParent match {
    case el: psi.Module => el
