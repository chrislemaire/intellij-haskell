...
import intellij.haskell.lang.cabal.psi.impl.{BuildDependsImpl, ExposedModulesImpl, ExtensionsImpl, GhcOptionsImpl, MainIsImpl, ModuleImpl, ModulePartImpl, SourceDirsImpl}
