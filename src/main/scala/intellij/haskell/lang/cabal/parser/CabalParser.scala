...
import intellij.haskell.lang.cabal.psi.{CabalComparatorTokenType, CabalElementType, CabalFieldKeyTokenType, CabalFuncLikeTokenType, CabalIdentTokenType, CabalLayoutTokenType, CabalLogicalTokenType, CabalStanzaArgTokenType, CabalStanzaKeyTokenType, CabalWordLikeTokenType}
